...
schema.statics.findDailyAgeCount = function(){
...
schema.statics.findDailyGenderCount = function(){
  return this.aggregate([
    [
      {
        '$lookup': {
...
schema.statics.findDailyFacilityCount = function(){
  return this.aggregate([
    [
      {
        '$lookup': {
...
schema.statics.findDailyRaceCount = function(){
  return this.aggregate([
    [
      {
        '$lookup': {
...
schema.statics.findDailyAgencyCount = function(){
  return this.aggregate([
    [
      {
        '$lookup': {
...
schema.statics.getAllChargeDesciptions = function(){
  return this.aggregate([
    [
      {
        '$unwind': {
...
module.exports = mongoose.model('MultScrape', schema);
