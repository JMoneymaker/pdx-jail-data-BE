...
schema.statics.findMostRecentRecord = function(){
...
schema.statics.findLatestTotal = function(){
  return this.aggregate([
    [
      {
        '$lookup': {
...
// schema.statics.getDailyTotals = function(){
//   return this.aggregate([
//     [
//       {
//         '$lookup': {
...
// schema.statics.getTwoDayTotals = function(){
//   return this.aggregate([
//     [
//       {
//         '$project': {
...
module.exports = mongoose.model('MultDetention', schema);
